...
func dropUserIfExists(db SQLDatabaseManager, ctx context.Context, username string) error {
...
func dropSchemaIfExists(db SQLDatabaseManager, ctx context.Context, schemaName string) error {
